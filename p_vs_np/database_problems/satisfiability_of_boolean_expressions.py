...
def test():
    print("Testing p_vs_np.database_problems.satisfiability_of_boolean_expressions...")
    main()
    print("p_vs_np.database_problems.satisfiability_of_boolean_expressions passed.")
