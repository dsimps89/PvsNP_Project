...
def test():
    print("Testing p_vs_np.database_problems.sequencing_to_minimize_maximum_cumulative_cost...")
    main()
    print("p_vs_np.database_problems.sequencing_to_minimize_maximum_cumulative_cost passed.")
