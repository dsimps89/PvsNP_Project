...
def test():
    print("Testing p_vs_np.database_problems.inequivalence_of_programs_with_assignments...")
    main()
    print("p_vs_np.database_problems.inequivalence_of_programs_with_assignments passed.")
