...
def test():
    print("Testing p_vs_np.database_problems.conjunctive_satisfiability_with_functions_and_inequalities...")
    main()
    print("p_vs_np.database_problems.conjunctive_satisfiability_with_functions_and_inequalities passed.")
