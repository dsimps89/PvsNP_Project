...
def test():
    print("Testing p_vs_np.database_problems.context_sensitive_language_membership...")
    main()
    print("p_vs_np.database_problems.context_sensitive_language_membership passed.")
