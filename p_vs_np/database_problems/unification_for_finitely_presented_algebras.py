...
def test():
    print("Testing p_vs_np.database_problems.unification_for_finitely_presented_algebras...")
    main()
    print("p_vs_np.database_problems.unification_for_finitely_presented_algebras passed.")
