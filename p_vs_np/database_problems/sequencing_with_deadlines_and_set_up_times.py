...
def test():
    print("Testing p_vs_np.database_problems.sequencing_with_deadlines_and_set_up_times...")
    main()
    print("p_vs_np.database_problems.sequencing_with_deadlines_and_set_up_times passed.")
