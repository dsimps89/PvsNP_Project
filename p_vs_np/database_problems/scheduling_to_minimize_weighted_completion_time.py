...
def test():
    print("Testing p_vs_np.database_problems.scheduling_to_minimize_weighted_completion_time...")
    main()
    print("p_vs_np.database_problems.scheduling_to_minimize_weighted_completion_time passed.")
