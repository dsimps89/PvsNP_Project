...
def test():
    print("Testing p_vs_np.database_problems.non_erasing_stack_automation_acceptance...")
    main()
    print("p_vs_np.database_problems.non_erasing_stack_automation_acceptance passed.")
