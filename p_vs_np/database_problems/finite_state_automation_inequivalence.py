...
def test():
    print("Testing p_vs_np.database_problems.finite_state_automation_inequivalence...")
    main()
    print("p_vs_np.database_problems.finite_state_automation_inequivalence passed.")
