...
def test():
    print("Testing p_vs_np.database_problems.travelling_salesman_polytope_non_adjacency...")
    main()
    print("p_vs_np.database_problems.travelling_salesman_polytope_non_adjacency passed.")
