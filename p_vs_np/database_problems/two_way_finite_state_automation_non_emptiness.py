...
def test():
    print("Testing p_vs_np.database_problems.two_way_finite_state_automation_non_emptiness...")
    main()
    print("p_vs_np.database_problems.two_way_finite_state_automation_non_emptiness passed.")
