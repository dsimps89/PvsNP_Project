...
def test():
    print("Testing p_vs_np.database_problems.periodic_solution_recurrence_relation...")
    main()
    print("p_vs_np.database_problems.periodic_solution_recurrence_relation passed.")
