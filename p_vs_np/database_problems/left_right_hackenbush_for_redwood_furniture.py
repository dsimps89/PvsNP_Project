...
def test():
    print("Testing p_vs_np.database_problems.left_right_hackenbush_for_redwood_furniture...")
    main()
    print("p_vs_np.database_problems.left_right_hackenbush_for_redwood_furniture passed.")
