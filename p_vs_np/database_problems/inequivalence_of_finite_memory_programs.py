...
def test():
    print("Testing p_vs_np.database_problems.inequivalence_of_finite_memory_programs...")
    main()
    print("p_vs_np.database_problems.inequivalence_of_finite_memory_programs passed.")
