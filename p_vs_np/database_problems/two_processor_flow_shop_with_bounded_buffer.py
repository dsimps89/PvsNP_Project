...
def test():
    print("Testing p_vs_np.database_problems.two_processor_flow_shop_with_bounded_buffer...")
    main()
    print("p_vs_np.database_problems.two_processor_flow_shop_with_bounded_buffer passed.")
