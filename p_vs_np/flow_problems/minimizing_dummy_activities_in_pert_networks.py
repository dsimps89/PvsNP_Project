...
def test():
    print("Testing p_vs_np.flow_problems.minimizing_dummy_activities_in_pert_networks...")
    main()
    print("p_vs_np.flow_problems.minimizing_dummy_activities_in_pert_networks passed.")
