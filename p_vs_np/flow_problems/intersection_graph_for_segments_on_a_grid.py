...
def test():
    print("Testing p_vs_np.flow_problems.intersection_graph_for_segments_on_a_grid...")
    main()
    print("p_vs_np.flow_problems.intersection_graph_for_segments_on_a_grid passed.")
