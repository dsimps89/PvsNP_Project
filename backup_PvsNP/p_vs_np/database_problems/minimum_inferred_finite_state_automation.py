...
def test():
    print("Testing p_vs_np.database_problems.minimum_inferred_finite_state_automation...")
    main()
    print("p_vs_np.database_problems.minimum_inferred_finite_state_automation passed.")
