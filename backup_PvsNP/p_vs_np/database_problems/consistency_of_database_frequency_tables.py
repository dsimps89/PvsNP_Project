...
def test():
    print("Testing p_vs_np.database_problems.consistency_of_database_frequency_tables...")
    main()
    print("p_vs_np.database_problems.consistency_of_database_frequency_tables passed.")
