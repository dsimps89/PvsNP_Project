...
def test():
    print("Testing p_vs_np.database_problems.linear_bounded_automation_acceptance...")
    main()
    print("p_vs_np.database_problems.linear_bounded_automation_acceptance passed.")
