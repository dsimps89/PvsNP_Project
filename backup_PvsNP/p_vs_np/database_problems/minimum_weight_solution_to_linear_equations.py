...
def test():
    print("Testing p_vs_np.database_problems.minimum_weight_solution_to_linear_equations...")
    main()
    print("p_vs_np.database_problems.minimum_weight_solution_to_linear_equations passed.")
