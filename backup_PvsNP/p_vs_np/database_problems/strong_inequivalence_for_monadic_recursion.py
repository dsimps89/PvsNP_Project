...
def test():
    print("Testing p_vs_np.database_problems.strong_inequivalence_for_monadic_recursion...")
    main()
    print("p_vs_np.database_problems.strong_inequivalence_for_monadic_recursion passed.")
