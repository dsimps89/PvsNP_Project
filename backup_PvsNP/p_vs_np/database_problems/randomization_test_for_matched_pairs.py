...
def test():
    print("Testing p_vs_np.database_problems.randomization_test_for_matched_pairs...")
    main()
    print("p_vs_np.database_problems.randomization_test_for_matched_pairs passed.")
