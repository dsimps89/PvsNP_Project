...
def test():
    print("Testing p_vs_np.database_problems.sequencing_to_minimize_tardy_task_weight...")
    main()
    print("p_vs_np.database_problems.sequencing_to_minimize_tardy_task_weight passed.")
