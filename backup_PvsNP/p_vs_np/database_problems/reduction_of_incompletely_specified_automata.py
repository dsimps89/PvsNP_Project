...
def test():
    print("Testing p_vs_np.database_problems.reduction_of_incompletely_specified_automata...")
    main()
    print("p_vs_np.database_problems.reduction_of_incompletely_specified_automata passed.")
