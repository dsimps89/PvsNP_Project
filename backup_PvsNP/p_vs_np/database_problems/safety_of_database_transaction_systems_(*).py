...
def test():
    print("Testing p_vs_np.database_problems.safety_of_database_transaction_systems_(*)...")
    main()
    print("p_vs_np.database_problems.safety_of_database_transaction_systems_(*) passed.")
