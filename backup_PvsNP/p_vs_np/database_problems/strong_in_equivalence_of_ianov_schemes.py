...
def test():
    print("Testing p_vs_np.database_problems.strong_in_equivalence_of_ianov_schemes...")
    main()
    print("p_vs_np.database_problems.strong_in_equivalence_of_ianov_schemes passed.")
