...
def test():
    print("Testing p_vs_np.database_problems.scheduling_with_individual_deadlines...")
    main()
    print("p_vs_np.database_problems.scheduling_with_individual_deadlines passed.")
