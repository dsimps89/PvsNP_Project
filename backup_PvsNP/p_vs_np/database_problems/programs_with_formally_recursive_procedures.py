...
def test():
    print("Testing p_vs_np.database_problems.programs_with_formally_recursive_procedures...")
    main()
    print("p_vs_np.database_problems.programs_with_formally_recursive_procedures passed.")
