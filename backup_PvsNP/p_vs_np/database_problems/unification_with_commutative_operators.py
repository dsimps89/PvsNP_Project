...
def test():
    print("Testing p_vs_np.database_problems.unification_with_commutative_operators...")
    main()
    print("p_vs_np.database_problems.unification_with_commutative_operators passed.")
