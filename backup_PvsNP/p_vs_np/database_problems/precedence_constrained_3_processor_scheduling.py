...
def test():
    print("Testing p_vs_np.database_problems.precedence_constrained_3_processor_scheduling...")
    main()
    print("p_vs_np.database_problems.precedence_constrained_3_processor_scheduling passed.")
