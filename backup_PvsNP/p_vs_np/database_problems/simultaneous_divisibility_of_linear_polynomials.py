...
def test():
    print("Testing p_vs_np.database_problems.simultaneous_divisibility_of_linear_polynomials...")
    main()
    print("p_vs_np.database_problems.simultaneous_divisibility_of_linear_polynomials passed.")
