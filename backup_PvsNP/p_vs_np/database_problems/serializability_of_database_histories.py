...
def test():
    print("Testing p_vs_np.database_problems.serializability_of_database_histories...")
    main()
    print("p_vs_np.database_problems.serializability_of_database_histories passed.")
