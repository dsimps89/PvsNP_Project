...
def test():
    print("Testing p_vs_np.database_problems.structural_inequivalence_for_linear_grammars...")
    main()
    print("p_vs_np.database_problems.structural_inequivalence_for_linear_grammars passed.")
