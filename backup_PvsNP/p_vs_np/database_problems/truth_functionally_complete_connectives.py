...
def test():
    print("Testing p_vs_np.database_problems.truth_functionally_complete_connectives...")
    main()
    print("p_vs_np.database_problems.truth_functionally_complete_connectives passed.")
