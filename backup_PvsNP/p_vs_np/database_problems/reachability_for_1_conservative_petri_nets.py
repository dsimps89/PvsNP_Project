...
def test():
    print("Testing p_vs_np.database_problems.reachability_for_1_conservative_petri_nets...")
    main()
    print("p_vs_np.database_problems.reachability_for_1_conservative_petri_nets passed.")
