...
def test():
    print("Testing p_vs_np.database_problems.non_liveness_of_free_choice_petri_nets...")
    main()
    print("p_vs_np.database_problems.non_liveness_of_free_choice_petri_nets passed.")
