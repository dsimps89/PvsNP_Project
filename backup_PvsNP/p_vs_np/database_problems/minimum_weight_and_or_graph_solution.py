...
def test():
    print("Testing p_vs_np.database_problems.minimum_weight_and_or_graph_solution...")
    main()
    print("p_vs_np.database_problems.minimum_weight_and_or_graph_solution passed.")
