...
def test():
    print("Testing p_vs_np.database_problems.sequencing_with_release_times_and_deadlines...")
    main()
    print("p_vs_np.database_problems.sequencing_with_release_times_and_deadlines passed.")
