...
def test():
    print("Testing p_vs_np.database_problems.number_of_roots_for_a_product_polynomial...")
    main()
    print("p_vs_np.database_problems.number_of_roots_for_a_product_polynomial passed.")
