...
def test():
    print("Testing p_vs_np.database_problems.alternating__maximum_weighted_matching...")
    main()
    print("p_vs_np.database_problems.alternating__maximum_weighted_matching passed.")
