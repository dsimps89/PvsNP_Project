...
def test():
    print("Testing p_vs_np.database_problems.sequencing_to_minimize_weighted_tardiness...")
    main()
    print("p_vs_np.database_problems.sequencing_to_minimize_weighted_tardiness passed.")
