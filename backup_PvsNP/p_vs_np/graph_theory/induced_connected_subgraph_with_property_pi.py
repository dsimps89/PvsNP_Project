...
def test():
    print("Testing p_vs_np.graph_theory.induced_connected_subgraph_with_property_pi...")
    main()
    print("p_vs_np.graph_theory.induced_connected_subgraph_with_property_pi passed.")
